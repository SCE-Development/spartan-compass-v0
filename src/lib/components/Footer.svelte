	...
	<nav>
		...
		<div class="grid grid-flow-col gap-4">
			<a
				...
				target="_blink"
				class="text-gray-500 transition-colors duration-300 hover:text-primary dark:text-gray-300 dark:hover:text-primary"
			>
				<svg
			...
			<a
				href="https://www.youtube.com/channel/UCY4KDJ7fUrHf5r1sqQWnMVg"
				rel="nofollow noreferrer"
				target="_blink"
				class="text-gray-500 transition-colors duration-300 hover:text-primary dark:text-gray-300 dark:hover:text-primary"
			>
			...
			<a
				href="https://github.com/SCE-Development"
				rel="nofollow noreferrer"
				target="_blink"
				class="text-gray-500 transition-colors duration-300 hover:text-primary dark:text-gray-300 dark:hover:text-primary"
			>
