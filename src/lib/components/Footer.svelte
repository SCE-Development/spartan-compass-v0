<script lang="ts">
	import SCElogo from '$lib/images/SCElogo.png';
</script>

<footer
	class="footer p-10 text-neutral-content"
	style="position: absolute; bottom: 0; width: 100%; justify-content: center; background-color: #1a202c;"
>
    
	<aside>
        <a href="https://sce.sjsu.edu/">
            <img src={SCElogo} width="100" height="100" alt="sce-logo" />
        </a>
	...
	<nav>
		...
		<div class="grid grid-flow-col gap-4">
			<a href="https://sce.sjsu.edu/s/discord" rel="nofollow noreferrer" target="_blink" class="text-gray-500 transition-colors duration-300 dark:text-gray-300 hover:text-primary dark:hover:text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0,0,256,256">
                <g fill="#cccbcb" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-Miterlimit="10" stroke-Dasharray="" stroke-Dashoffset="0" font-Family="none" font-Weight="none" font-Size="none" text-Anchor="none">
              ...
              <a href="https://www.youtube.com/channel/UCY4KDJ7fUrHf5r1sqQWnMVg" rel="nofollow noreferrer" target="_blink" class="text-gray-500 transition-colors duration-300 dark:text-gray-300 hover:text-primary dark:hover:text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0,0,256,256">
                <g fill="#cccbcb" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-Miterlimit="10" stroke-Dasharray="" stroke-Dashoffset="0" font-Family="none" font-Weight="none" font-Size="none" text-Anchor="none">
                    <g transform="scale(5.12,5.12)">
              ...
              <a href="https://github.com/SCE-Development" rel="nofollow noreferrer" target="_blink" class="text-gray-500 transition-colors duration-300 dark:text-gray-300 hover:text-primary dark:hover:text-primary">
